...
if(PCSX2_TARGET_IOS)
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/libpng/CMakeLists.txt")
        ...
        if(TARGET png)
            ...
            message(STATUS "iOS: Using bundled libpng")
        endif()
    endif()
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/plutovg/CMakeLists.txt")
        ...
        if(TARGET plutovg)
            ...
            set(plutovg_INCLUDE_DIRS "${CMAKE_SOURCE_DIR}/3rdparty/plutovg/include")
            message(STATUS "iOS: Using bundled plutovg")
        endif()
    endif()
    ...
    if(EXISTS "${CMAKE_SOURCE_DIR}/3rdparty/plutosvg/CMakeLists.txt")
        ...
        if(TARGET plutosvg)
            ...
            message(STATUS "iOS: Using bundled plutosvg")
        endif()
    endif()
endif()
